<%@ Page Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" CodeFile="SetupField_GridField.aspx.cs" Inherits="WKF_OptionalFields_SetupField_GridField" Title="" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
...
<table width="100%" class="PopTable" cellspacing="1">
    ...
    <colgroup class="PopTableRightTD">	</colgroup>
    <tr>
        <td align="center" class="PopTableHeader" colspan="4"><asp:Label ID="lblSingleLine" runat="server" Text="表格欄位" meta:resourcekey="lblSingleLineResource1"></asp:Label></td>
    </tr>
    <tr>
