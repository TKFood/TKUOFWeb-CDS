<%@ Page Title="" Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" CodeFile="SelectUserFilterGroup.aspx.cs" Inherits="CDS_KYTUtils_QUERYWINDOWS_SelectUserFilterGroup" %>
        ...
        <ContentTemplate>
            <div class="Content">
                <div class="Main">
                    ...
                    <input type="checkbox" id="OpenSelect" checked="checked" hidden />
