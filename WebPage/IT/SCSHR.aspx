<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SCSHR.aspx.cs" MasterPageFile="~/Master/DefaultMasterPage.master" Inherits="CDS_WebPage_SCSHR" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <telerik:RadTabStrip ID="RadTabStrip2" runat="server" MultiPageID="RadMultiPage" SelectedIndex="0">
        <Tabs>
            <telerik:RadTab Text="個人出缺勤狀況查詢">
            </telerik:RadTab>
            <telerik:RadTab Text="報表查詢">
            </telerik:RadTab>
        </Tabs>
    </telerik:RadTabStrip>
