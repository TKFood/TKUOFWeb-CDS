<%@ Page Title="" Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" CodeFile="TKRESEARCHTBPROJECTDialogMEMOADD.aspx.cs" Inherits="CDS_WebPage_TKRESEARCHTBPROJECTDialogMEMOADD" %>
...
<script>
    ...
    <table class="PopTable" >
        <tr>
            <td class="PopTableLeftTD" >
                <asp:Label ID="Label1" runat="server" Text="TKRESEARCHTBPROJECTDialogMEMOADD"></asp:Label>
            </td>
    ...
    <table class="PopTable">
         <tr>
            ...
            <td class="PopTableRightTD">
                <asp:TextBox ID="TextBox3" runat="server"  Text="" Width = "100%"  TextMode="MultiLine"  Rows="10"></asp:TextBox>
            </td> 
       </tr>
    </table>
     <table class="PopTable">
