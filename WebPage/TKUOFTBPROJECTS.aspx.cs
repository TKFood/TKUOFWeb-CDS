...
public partial class CDS_WebPage_TKUOFTBPROJECTS : Ede.Uof.Utility.Page.BasePage
{
    ...
    protected void Grid1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            Dialog.Open2(lbtnName, "~/CDS/WebPage/TKUOFTBPROJECTSDialogEDITDEL.aspx", "", 1000, 800, Dialog.PostBackType.AfterReturn, param);
        }
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            //Grid開窗是用RowDataBound事件再開窗
            Dialog.Open2(MEMO, "~/CDS/WebPage/TKUOFTBPROJECTSMEMOADD.aspx", "", 1000, 800, Dialog.PostBackType.AfterReturn, param);
        }
    }
