<%@ Page Title="" Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" CodeFile="TBBU_TBPROJECTSSALESDialogEDITDEL.aspx.cs" Inherits="CDS_WebPage_TBBU_TBPROJECTSSALESDialogEDITDEL" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table>
        ...
        <tr>
            <td class="PopTableLeftTD">
                <asp:Label ID="Label6" runat="server" Text="活動名稱"></asp:Label>
            </td>
            <td class="PopTableRightTD">
                <asp:TextBox ID="TextBox3" runat="server" Text="" Width="200%" TextMode="MultiLine" Row="5" Style="height: 120px;"></asp:TextBox>
            </td>
        ...
        <tr>
            <td class="PopTableLeftTD">
                <asp:Label ID="Label7" runat="server" Text="活動品項"></asp:Label>
            </td>
            <td class="PopTableRightTD">
        ...
        <tr>
            <td class="PopTableLeftTD">
                <asp:Label ID="Label8" runat="server" Text="預估支出費用"></asp:Label>
            </td>
            <td class="PopTableRightTD">
    ...
    <table>
        ...
        <tr>
            ...
            <td class="PopTableRightTD">
                <asp:TextBox ID="TextBox8" runat="server" Text="" MaxLength="2" Width="200%" Row="1" Style="height: 20px;"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="PopTableLeftTD">
                <asp:Label ID="Label12" runat="server" Text="是否複製"></asp:Label>
            </td>
            <td class="PopTableRightTD">
