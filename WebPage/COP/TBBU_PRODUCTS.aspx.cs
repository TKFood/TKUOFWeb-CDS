...
public partial class CDS_WebPage_COP_TBBU_PRODUCTS : Ede.Uof.Utility.Page.BasePage
{
    ...
    public void SETDATE()
    {
        ...
        TextBox22.Text = firstDayOfLastMonth.ToString("yyyyMMdd");
    ...
    private void BindDropDownList3()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            DropDownList3.DataTextField = "SALESFOCUS";
            DropDownList3.DataValueField = "SALESFOCUS";
    ...
    private void BindDropDownList4()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            DropDownList4.DataTextField = "COMPANYS";
            DropDownList4.DataValueField = "COMPANYS";
    ...
    {
        EXPORT_NEW_PRODUCT(TextBox22.Text.Trim());


    }
    public void EXPORT_NEW_PRODUCT(string NEWDATES)
    {
        ...
        if (!string.IsNullOrEmpty(NEWDATES))
        {
            QUERYS.AppendFormat(@" AND CREATE_DATE>='{0}' ", NEWDATES);
        }
    ...
    protected void btn3_Click(object sender, System.EventArgs e)
    {
        ...
        {
            FIND_NEW_PRODUCT(TextBox22.Text.Trim());
        }
