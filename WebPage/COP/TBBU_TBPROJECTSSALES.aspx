<%@ Page Title="" Language="C#" MasterPageFile="~/Master/DefaultMasterPage.master" AutoEventWireup="true" CodeFile="TBBU_TBPROJECTSSALES.aspx.cs" Inherits="CDS_WebPage_TBBU_TBPROJECTSSALES" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script>    
        function btn4_Click(sender) {
            ...
            //參數使用JSON格式傳遞
            $uof.dialog.open2("~/CDS/WebPage/COP/TBBU_TBPROJECTSSALESDialogADD.aspx", sender, "", 800, 600, OpenDialogResult, {});
