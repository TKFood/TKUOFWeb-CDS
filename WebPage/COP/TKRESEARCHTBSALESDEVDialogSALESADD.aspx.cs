...
public partial class CDS_WebPage_TKRESEARCHTBSALESDEVDialogSALESADD : Ede.Uof.Utility.Page.BasePage
{
    ...
    public void SEARCHTBSALESDEV(string ID)
    {
        ...
        string cmdTxt = @" 
                        SELECT [ID],[SERNO],[STATUS],[CLIENT],[PROD],[PRICES],[PROMOTIONS],[SPEC],[VALID],[PLACES],[ONSALES],[PRODESGIN],CONVERT(NVARCHAR,[ASSESSMENTDATES],111) ASSESSMENTDATES,CONVERT(NVARCHAR,[COSTSDATES],111) COSTSDATES,[SALESPRICES],[TEST],CONVERT(NVARCHAR,[TESTDATES],111) TESTDATES,[OWNER],[MEMO] 
                        FROM [TKRESEARCH].[dbo].[TBSALESDEVMEMO] 
                        WHERE [ID]=@ID  
                        ";
