            ...
            <div id="tabs-1">
                <table class="PopTable">
                    ...
                    <tr>
                        ...
                        <td class="PopTableRightTD">
                            <telerik:RadDatePicker ID="RadDatePicker1" runat="server" Width="120px" OnSelectedDateChanged="RadDateTimePicker1_SelectedDateChanged"  AutoPostBack="true"></telerik:RadDatePicker>
