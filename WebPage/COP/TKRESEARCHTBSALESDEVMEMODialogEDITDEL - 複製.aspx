<%@ Page Title="" Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" CodeFile="TKRESEARCHTBSALESDEVMEMODialogEDITDEL - 複製.aspx.cs" Inherits="CDS_WebPage_TKRESEARCHTBSALESDEVMEMODialogEDITDEL" %>
        ...
        <tr>
         ...
         <tr>
            ...
            <td class="PopTableRightTD">
             ...
             <tr>
            <td class="PopTableLeftTD" >
                <asp:Label ID="Label15" runat="server" Text="報價日期 申請日期"></asp:Label>
            </td>
            <td class="PopTableRightTD">
          ...
          <tr>
            ...
            <td class="PopTableRightTD">
             ...
             <tr>
            <td class="PopTableLeftTD" >
                <asp:Label ID="Label20" runat="server" Text="研發進度"></asp:Label>
            </td>
            <td class="PopTableRightTD">
                <asp:TextBox ID="TextBox15" runat="server"  Text="" TextMode="MultiLine" Width = "100%" ReadOnly="true" ></asp:TextBox>
            </td> 
       </tr>
    <table>
        <tr>
