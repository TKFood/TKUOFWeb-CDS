<%@ Page Title="" Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" CodeFile="TBBU_TBSALESSCHEDULESDialogADD.aspx.cs" Inherits="CDS_WebPage_TBBU_TBSALESSCHEDULESDialogADD" %>
    ...
    <table class="PopTable" >
        <tr>
            <td class="PopTableLeftTD" >
                <asp:Label ID="Label1" runat="server" Text="CDS_WebPage_TBBU_TBSALESSCHEDULESDialogADD"></asp:Label>
            </td>
         ...
         <tr>
            <td class="PopTableLeftTD" >
                <asp:Label ID="Label4" runat="server" Text="事件"></asp:Label>
            </td>
            <td class="PopTableRightTD">
         ...
         <tr>
            <td class="PopTableLeftTD" >
                <asp:Label ID="Label5" runat="server" Text="1月"></asp:Label>
            </td>
            <td class="PopTableRightTD">
         ...
         <tr>
            <td class="PopTableLeftTD" >
                <asp:Label ID="Label6" runat="server" Text="2月"></asp:Label>
            </td>
            <td class="PopTableRightTD">
         ...
         <tr>
            <td class="PopTableLeftTD" >
                <asp:Label ID="Label7" runat="server" Text="3月"></asp:Label>
            </td>
            <td class="PopTableRightTD">
         ...
         <tr>
            <td class="PopTableLeftTD" >
                <asp:Label ID="Label8" runat="server" Text="4月"></asp:Label>
            </td>
            <td class="PopTableRightTD">
         ...
         <tr>
            <td class="PopTableLeftTD" >
                <asp:Label ID="Label9" runat="server" Text="5月"></asp:Label>
            </td>
            <td class="PopTableRightTD">
         ...
         <tr>
            <td class="PopTableLeftTD" >
                <asp:Label ID="Label10" runat="server" Text="6月"></asp:Label>
            </td>
            <td class="PopTableRightTD">
         ...
         <tr>
            <td class="PopTableLeftTD" >
                <asp:Label ID="Label11" runat="server" Text="7月"></asp:Label>
            </td>
            <td class="PopTableRightTD">
         ...
         <tr>
            <td class="PopTableLeftTD" >
                <asp:Label ID="Label12" runat="server" Text="8月"></asp:Label>
            </td>
            <td class="PopTableRightTD">
         ...
         <tr>
            <td class="PopTableLeftTD" >
                <asp:Label ID="Label13" runat="server" Text="9月"></asp:Label>
            </td>
            <td class="PopTableRightTD">
         ...
         <tr>
            <td class="PopTableLeftTD" >
                <asp:Label ID="Label14" runat="server" Text="10月"></asp:Label>
            </td>
            <td class="PopTableRightTD">
         ...
         <tr>
            <td class="PopTableLeftTD" >
                <asp:Label ID="Label15" runat="server" Text="11月"></asp:Label>
            </td>
            <td class="PopTableRightTD">
         ...
         <tr>
            <td class="PopTableLeftTD" >
                <asp:Label ID="Label16" runat="server" Text="12月"></asp:Label>
            </td>
            <td class="PopTableRightTD">
