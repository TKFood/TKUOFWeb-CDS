<%@ Page Title="" Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" CodeFile="Mobile_TBBU_TBSALESEVENTSFORSALESDialogEDITDEL.aspx.cs" Inherits="CDS_WebPage_Mobile_TBBU_TBSALESEVENTSFORSALESDialogEDITDEL" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table class="PopTable">
        <tr>
            <td class="PopTableLeftTD">
                <asp:Label ID="Label1" runat="server" Text="Mobile_TBBU_TBSALESEVENTSFORSALESDialogEDITDEL"></asp:Label>
            </td>
    ...
    <table>
        ...
        <tr>
            ...
            <td class="PopTableRightTD">
                <asp:TextBox ID="TextBox6" runat="server" Text="" Width="200%" TextMode="MultiLine" Row="5" Style="height: 120px;" ReadOnly="true"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="PopTableLeftTD">
