<%@ Page Title="" Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" CodeFile="Mobile_TBBU_TBSALESEVENTSFORSALESDialogADD.aspx.cs" Inherits="CDS_WebPage_Mobile_TBBU_TBSALESEVENTSFORSALESDialogADD" %>
    ...
    <table class="PopTable">
        <tr>
            <td class="PopTableLeftTD">
                <asp:Label ID="Label1" runat="server" Text="Mobile_TBBU_TBSALESEVENTSFORSALESDialogADD"></asp:Label>
            </td>
