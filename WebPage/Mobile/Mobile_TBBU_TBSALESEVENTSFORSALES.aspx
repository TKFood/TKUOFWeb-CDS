<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MobileMasterPage.master" AutoEventWireup="true" CodeFile="Mobile_TBBU_TBSALESEVENTSFORSALES.aspx.cs" Inherits="CDS_WebPage_Mobile_TBBU_TBSALESEVENTSFORSALES" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script>    
        function btn4_Click(sender) {
            ...
            //參數使用JSON格式傳遞
            $uof.dialog.open2("~/CDS/WebPage/Mobile/Mobile_TBBU_TBSALESEVENTSFORSALESDialogADD.aspx", sender, "", 1000, 1000, OpenDialogResult, {});
