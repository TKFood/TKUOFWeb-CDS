<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UC_KYTI_SCSHR_EMPJOB.ascx.cs" Inherits="WKF_OptionalFields_UC_KYTI_SCSHR_EMPJOB" %>
...
<script>
   ...
   */
     ...
     * @param args
     */
    function checkDUTYID(sender, args) {
        var kddlDUTYID = $("#<%=kddlDUTYID.ClientID%>_DropDownList1");
        if (kddlDUTYID.length > 0) {
            args.IsValid = kddlDUTYID.val() != null && kddlDUTYID.val() != "";
        }
    }
     ...
     * @param args
     */
    function checkSSTARTDATE(sender, args) {
        var kdpSSTARTDATE = $("#<%=kdpSSTARTDATE.ClientID%>_textBox1");
        if (kdpSSTARTDATE.length > 0) {
            args.IsValid = kdpSSTARTDATE.val() != "";
        }
    }
    ...
    <ContentTemplate>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <uc1:KYTTextBox runat="server" ID="ktxtEMPLOYEE" />
                    <!--自動帶入，申請人，顯示姓名與帳號-->
                ...
                <div class="col-md-4">
                    <uc1:KYTDropDownList runat="server" ID="kddlADJUSTTYPE" RepeatDirection="Horizontal">
                        <asp:ListItem Value="0" Selected="True">0-試用</asp:ListItem>
                        <asp:ListItem Value="1">1-正式</asp:ListItem>
                        <asp:ListItem Value="2">2-約聘</asp:ListItem>
                    </uc1:KYTDropDownList>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <asp:CustomValidator ID="CustomValidator1" runat="server" ErrorMessage="<br />必須填寫申報公司" ForeColor="Red" ClientValidationFunction="checkCOMPANYID" Display="Dynamic"></asp:CustomValidator>
                </div>
                <div class="col-md-2 bg-light divtitle">
                    <span class="color_red">*</span>
                    帳務部門 
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <uc1:KYTDatePicker runat="server" ID="kdpSTARTDATE"  />
                    <!--STARTDATE-->
                    <asp:CustomValidator ID="CustomValidator4" runat="server" ErrorMessage="必須填寫到職日期" ForeColor="Red" ClientValidationFunction="checkSTARTDATE" Display="Dynamic"></asp:CustomValidator>
                </div>
            </div>
            <div class="row">
                <div class="col-md-2 bg-light divtitle">
                ...
                <div class="col-md-4">
                    <uc1:KYTDatePicker runat="server" ID="kdpTRIALDATE" />
                    <!--TRIALDATE-->
                </div>
                <div class="col-md-2 bg-light divtitle">
                    <span class="color_red">*</span>
                ...
                <div class="col-md-4">
                    <uc1:KYTDatePicker runat="server" ID="kdpSSTARTDATE"  />
                    <!--SSTARTDATE-->
                    <asp:CustomValidator ID="CustomValidator5" runat="server" ErrorMessage="必須填寫(特休)年資起始日" ForeColor="Red" ClientValidationFunction="checkSSTARTDATE" Display="Dynamic"></asp:CustomValidator>
                </div>
            </div>
            <div class="row">
                <div class="col-md-2 bg-light divtitle">
                ...
                <div class="col-md-4">
                    <uc1:KYTDatePicker runat="server" ID="kdpGARRIVEDATE"  />
                    <!--GARRIVEDATE-->
                </div>
                <div class="col-md-2 bg-light divtitle">
                    職稱
                ...
                <div class="col-md-4">
                    ...
                    <asp:CustomValidator ID="CustomValidator2" runat="server" ErrorMessage="<br />必須填寫職稱" ForeColor="Red" ClientValidationFunction="checkDUTYID" Display="Dynamic"></asp:CustomValidator>
                </div>
            </div>
            <div class="row">
                <div class="col-md-2 bg-light divtitle">
                ...
                <div class="col-md-4">
                    ...
                    <asp:CustomValidator ID="CustomValidator3" runat="server" ErrorMessage="<br />必須填寫參考代碼" ForeColor="Red" ClientValidationFunction="checkIDYCLASSID" Display="Dynamic"></asp:CustomValidator>
                </div>
            </div>
            <div class="row">
                <div class="col-md-2 bg-light divtitle">
