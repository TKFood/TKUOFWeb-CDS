...
/// 個人加班資料查詢
/// </summary>
public partial class WB_KYTI_SCSHR_OVERTIME_REPORT : BasePage
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        out ex);
        //JGlobalLibs.DebugLog.Log(string.Format(@"WB_KYTI_SCSHR_OVERTIME_REPORT.btnSearch_Click.BOExecFunc::{0}::Send::{1}", "WATT0022450", ((DateTime)kdtpSTARTTIME.SelectedDate).ToString("yyyyMMdd") + " , " + ((DateTime)kdtpENDTIME.SelectedDate).ToString("yyyyMMdd") + " , " + accounts));
        //JGlobalLibs.DebugLog.Log(string.Format(@"WB_KYTI_SCSHR_OVERTIME_REPORT.btnSearch_Click.BOExecFunc::{0}::Result::{1}", "WATT0022450", Newtonsoft.Json.JsonConvert.SerializeObject(parameters)));

        if (ex != null)
            JGlobalLibs.DebugLog.Log(string.Format(@"WB_KYTI_SCSHR_OVERTIME_REPORT.btnSearch_Click.BOExecFunc.ERROR:{0}", ex.Message));
        if (parameters != null &&
            parameters.Length > 0)
        {
    ...
    private DataTable CreateGvitem()
    {
        ...
        dt.Columns.Add(new DataColumn("CALCTYPE", typeof(String))); // 加班屬性
        dt.Columns.Add(new DataColumn("OVERCOMPHOURS", typeof(String))); // 補休可休時數 
        dt.Columns.Add(new DataColumn("LEAVEHOURS", typeof(String))); // 補休已休時數 
        dt.Columns.Add(new DataColumn("CLOSEHOURS", typeof(String))); // 補休結清時數 
        dt.Columns.Add(new DataColumn("ROVERCOMPHOURS", typeof(String))); // 補休剩餘時數 
        dt.Columns.Add(new DataColumn("MFREEDATE", typeof(String))); // 補休可休期限 
        dt.Columns.Add(new DataColumn("NOTE", typeof(String))); // 加班說明 
        dt.Columns.Add(new DataColumn("TMP_ATTENDSUMID", typeof(String))); // 出勤彙總單單號 

        //dt.Columns.Add(new DataColumn("EMPLOYEEID", typeof(String))); // 員工工號
        //dt.Columns.Add(new DataColumn("EMPLOYEENAME", typeof(String))); // 人員
        //dt.Columns.Add(new DataColumn("EMPLOYEEENGNAME", typeof(String))); 
        //dt.Columns.Add(new DataColumn("SYS_FLOWFORMSTATUS", typeof(String))); // 單況
        //dt.Columns.Add(new DataColumn("OVERTIMEID", typeof(String))); // 加班單號
        //dt.Columns.Add(new DataColumn("OVERTIMESYSID", typeof(String)));
        //dt.Columns.Add(new DataColumn("DATE", typeof(String))); // 申請日期
        //dt.Columns.Add(new DataColumn("WORKNAME", typeof(String))); // 加班班別
        //dt.Columns.Add(new DataColumn("WORKENGNAME", typeof(String)));
        //dt.Columns.Add(new DataColumn("DEPARTID", typeof(String)));
        //dt.Columns.Add(new DataColumn("TMP_DEPARTID", typeof(String))); // 部門編號
        //dt.Columns.Add(new DataColumn("DEPARTNAME", typeof(String))); // 部門名稱
        //dt.Columns.Add(new DataColumn("DEPARTENGNAME", typeof(String)));
        //dt.Columns.Add(new DataColumn("CDEPARTID", typeof(String)));
        //dt.Columns.Add(new DataColumn("TMP_CDEPARTID", typeof(String)));
        //dt.Columns.Add(new DataColumn("CDEPARTNAME", typeof(String)));
        //dt.Columns.Add(new DataColumn("CDEPARTENGNAME", typeof(String)));
        //dt.Columns.Add(new DataColumn("STARTDATE", typeof(String))); // 起始日期
        //dt.Columns.Add(new DataColumn("STARTTIME", typeof(String))); // 起始時間
        //dt.Columns.Add(new DataColumn("ENDDATE", typeof(String))); // 結束日期
        //dt.Columns.Add(new DataColumn("ENDTIME", typeof(String))); // 結束時間
        //dt.Columns.Add(new DataColumn("APPLYHOURS", typeof(String)));
        //dt.Columns.Add(new DataColumn("OVERTIMEHOURS", typeof(String))); // 加班時數
        //dt.Columns.Add(new DataColumn("CALCTYPE", typeof(String))); // 加班屬性
        //dt.Columns.Add(new DataColumn("OVERCOMPHOURS", typeof(String))); // 補休可休時數 
        //dt.Columns.Add(new DataColumn("LEAVEHOURS", typeof(String))); // 補休已休時數 
        ...
        //dt.Columns.Add(new DataColumn("ROVERCOMPHOURS", typeof(String))); // 補休剩餘時數 
        //dt.Columns.Add(new DataColumn("MFREEDATE", typeof(String))); // 補休可休期限 
        //dt.Columns.Add(new DataColumn("ATTENDSUMID", typeof(String)));
        //dt.Columns.Add(new DataColumn("TMP_ATTENDSUMID", typeof(String))); // 出勤彙總單單號 
        //dt.Columns.Add(new DataColumn("SOURCETAG", typeof(String)));
        //dt.Columns.Add(new DataColumn("TMP_SOURCEID", typeof(String)));
        //dt.Columns.Add(new DataColumn("NOTE", typeof(String))); // 加班說明 

        ////多餘
        //dt.Columns.Add(new DataColumn("SVACATIONNAME", typeof(String))); // 費用歸屬部門編號
        //dt.Columns.Add(new DataColumn("VACATIONNAME", typeof(String))); // 費用歸屬部門名稱
    ...
    protected void btnDLExcel_Click(object sender, EventArgs e)
    {
        ...
        {
            WebUtils.GridViewExportToExcel(stream, "個人加班資料查詢", gvItems, "微軟正黑體", "A1");
