<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WEB_KYTI_SCSHR_PUNCH_ERR_FIX.aspx.cs" MasterPageFile="~/Master/DefaultMasterPage.master" Inherits="CDS_SCSHR_WebPages_WEB_KYTI_SCSHR_PUNCH_ERR_FIX" %>
                ...
                <div>
                    <div class="row">
                        <div class="col-md-12 GridViewNormal">
                            <asp:GridView runat="server" ID="gvPUNCH"
                                CssClass="tsGridView2 horzFull"
                                AutoGenerateColumns="false"
                                ShowHeader="true"
                                ShowHeaderWhenEmpty="false"
                                OnRowDataBound="gvPUNCH_RowDataBound">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="忘刷單單單號">
                                        <ItemTemplate>
                                            <asp:Label ID="lblDOC_NBR" runat="server" Text='<%#Bind("DOC_NBR")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="忘刷人">
                                        <ItemTemplate>
