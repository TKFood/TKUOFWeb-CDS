<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WB_KYTI_SCSHR_LEAVE_REPORT.aspx.cs" MasterPageFile="~/Master/DefaultMasterPage.master" Inherits="WB_KYTI_SCSHR_LEAVE_REPORT" %>
                ...
                <div class="row">
                    <div class="col-md-12 GridViewNormal">
                        <asp:GridView runat="server" ID="gvItems"
                            ...
                            <EmptyDataTemplate>
                                <asp:Label ID="lblTip" runat="server" ForeColor="Red" Font-Bold="true" Text="無請假資料"></asp:Label>
                            </EmptyDataTemplate>
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="請假單號">
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblLEAVEID" Text='<%#Bind("LEAVEID")%>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="假別中類">
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblVACATIONNAME" Text='<%#Bind("VACATIONNAME")%>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="假別小類">
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblSVACATIONNAME" Text='<%#Bind("SVACATIONNAME")%>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="請假分鐘數">
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblLEAVEMINUTES" Text='<%#Bind("LEAVEMINUTES")%>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="銷假時數">
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblOFFLEAVEHOURS" Text='<%#Bind("OFFLEAVEHOURS")%>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="銷假分鐘數">
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblOFFLEAVEMINUTES" Text='<%#Bind("OFFLEAVEMINUTES")%>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="實際請假時數">
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblREALLEAVEHOURS" Text='<%#Bind("REALLEAVEHOURS")%>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="實際請假分鐘數">
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblREALLEAVEMINUTES" Text='<%#Bind("REALLEAVEMINUTES")%>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
