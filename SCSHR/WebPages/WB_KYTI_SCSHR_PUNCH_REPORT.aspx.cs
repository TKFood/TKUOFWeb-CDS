...
* 修改位置：
    * 「btnSearch_Click」中，查詢〈WATT0021502〉的結果註解
* **/
...
/// 個人刷卡查詢
/// </summary>
public partial class WB_KYTI_SCSHR_PUNCH_REPORT : BasePage
{
    ...
    protected void gvItems_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (gr.RowType == DataControlRowType.DataRow)
        {
            ...
            {
                case "0": ((Label)gr.FindControl("lblSOURCETYPE")).Text = "刷卡檔轉入"; break;
                case "1": ((Label)gr.FindControl("lblSOURCETYPE")).Text = "資料庫對接"; break;
                case "2": ((Label)gr.FindControl("lblSOURCETYPE")).Text = "線上補卡單"; break;
                case "3": ((Label)gr.FindControl("lblSOURCETYPE")).Text = "Web刷卡"; break;
                case "4": ((Label)gr.FindControl("lblSOURCETYPE")).Text = "App刷卡"; break;
                case "5": ((Label)gr.FindControl("lblSOURCETYPE")).Text = "自行新增"; break;
                case "6": ((Label)gr.FindControl("lblSOURCETYPE")).Text = "其它"; break;
            }

            switch (((HiddenField)gr.FindControl("hidDUTYSTATUS")).Value)
            {
                case "0": ((Label)gr.FindControl("lblDUTYSTATUS")).Text = "無法識別"; break;
                case "1": ((Label)gr.FindControl("lblDUTYSTATUS")).Text = "上班前加班上班"; break;
                case "2": ((Label)gr.FindControl("lblDUTYSTATUS")).Text = "上班前加班下班"; break;
                case "4": ((Label)gr.FindControl("lblDUTYSTATUS")).Text = "上班"; break;
                case "5": ((Label)gr.FindControl("lblDUTYSTATUS")).Text = "下班"; break;
                case "7": ((Label)gr.FindControl("lblDUTYSTATUS")).Text = "加班上班"; break;
                case "8": ((Label)gr.FindControl("lblDUTYSTATUS")).Text = "加班下班"; break;
            }
        }
    }
    ...
    private DataTable CreateGvitem()
    {
        ...
        dt.Columns.Add(new DataColumn("ATTENDDATE", typeof(String))); // 出勤班別日期
        dt.Columns.Add(new DataColumn("SWIPEDATE", typeof(String))); // 刷卡日期
        dt.Columns.Add(new DataColumn("SWIPETIME", typeof(String))); // 刷卡時間
        dt.Columns.Add(new DataColumn("SOURCETYPE", typeof(String))); // 來源
        dt.Columns.Add(new DataColumn("DUTYSTATUS", typeof(String))); // 識別
    ...
    protected void btnDLExcel_Click(object sender, EventArgs e)
    {
        ...
        {
            WebUtils.GridViewExportToExcel(stream, "個人刷卡查詢", gvItems, "微軟正黑體", "A1");
