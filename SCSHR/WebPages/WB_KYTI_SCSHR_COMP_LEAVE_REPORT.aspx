<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WB_KYTI_SCSHR_COMP_LEAVE_REPORT.aspx.cs" MasterPageFile="~/Master/DefaultMasterPage.master" Inherits="WB_KYTI_SCSHR_COMP_LEAVE_REPORT" %>
        ...
        <ContentTemplate>
            <div class="col-md-12 limitHeight" style="width: 100vw;">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        <asp:DropDownList runat="server" ID="ddlResidueHours">
                            <asp:ListItem Value="0">不顯示</asp:ListItem>
                ...
                <div class="row">
                    <div class="col-md-12 GridViewNormal">
                        <asp:GridView runat="server" ID="gvItems"
                            ...
                            <EmptyDataTemplate>
                                <asp:Label ID="lblTip" runat="server" ForeColor="Red" Font-Bold="true" Text="無補休資料"></asp:Label>
                            </EmptyDataTemplate>
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="來源">
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblSOURCETYPE" />
                                        <asp:HiddenField runat="server" ID="hidSOURCETYPE" Value='<%#Bind("SOURCETYPE")%>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="單號">
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblSOURCEID" Text='<%#Bind("SOURCEID")%>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="可休期限">
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblENDDATE" Text='<%#Bind("ENDDATE")%>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="平日時數">
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblGHOURS" Text='<%#Bind("GHOURS")%>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="休息日(H)時數">
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblHHOURS" Text='<%#Bind("HHOURS")%>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="例假日(H2)時數">
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblH2HOURS" Text='<%#Bind("H2HOURS")%>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="變形休息日(H3)時數">
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblH3HOURS" Text='<%#Bind("H3HOURS")%>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="國定假日(H4)時數">
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblH4HOURS" Text='<%#Bind("H4HOURS")%>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="特殊日時數">
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblSHOURS" Text='<%#Bind("SHOURS")%>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
