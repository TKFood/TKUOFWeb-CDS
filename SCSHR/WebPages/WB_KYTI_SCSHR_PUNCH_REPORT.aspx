<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WB_KYTI_SCSHR_PUNCH_REPORT.aspx.cs" MasterPageFile="~/Master/DefaultMasterPage.master" Inherits="WB_KYTI_SCSHR_PUNCH_REPORT" %>
                ...
                <div class="row">
                    <div class="col-md-12 GridViewNormal">
                        <asp:GridView runat="server" ID="gvItems"
                            ...
                            <EmptyDataTemplate>
                                <asp:Label ID="lblTip" runat="server" ForeColor="Red" Font-Bold="true" Text="無刷卡資料"></asp:Label>
                            </EmptyDataTemplate>
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="出勤班別日期">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="刷卡日期">
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblSWIPEDATE" Text='<%#Bind("SWIPEDATE")%>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="識別">
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblDUTYSTATUS" />
                                        <asp:HiddenField runat="server" ID="hidDUTYSTATUS" Value='<%#Bind("DUTYSTATUS")%>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
