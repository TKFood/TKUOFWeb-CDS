<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WEB_KYTI_SCSHR_OVERTIME_BATCH_ERR_FIX.aspx.cs" MasterPageFile="~/Master/DefaultMasterPage.master" Inherits="CDS_SCSHR_WebPages_WEB_KYTI_SCSHR_OVERTIME_BATCH_ERR_FIX" %>
            ...
            <div class="col-md-12 limitHeight" style="width: 100vw;">
                ...
                <div class="row">
                    <div class="col-md-12" style="margin: 12px 0;">
                        ...
                        <asp:Button ID="btnCheckAll" runat="server" Text="檢查所有表單" OnClick="btnCheckAll_Click" />
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12" style="margin: 12px 0;">
                        <asp:Button ID="btnReCalcByBOFind" runat="server" Text="BOFind同步" OnClick="btnReCalcByBOFind_Click" />
                        <asp:Button ID="btnReCalc" runat="server" Text="重算所有表單" OnClick="btnReCalc_Click" />
                        <asp:Button ID="btnReBuild" runat="server" Text="重轉" OnClick="btnReBuild_Click" />
                    </div>
                </div>
                <div>
                    <asp:Repeater ID="rptOVHBatch" runat="server"
                        OnItemDataBound="rptOVHBatch_ItemDataBound">
                        <ItemTemplate>
                            <div class="row RowTitle">
                                表單單號：<asp:Label ID="lblDOC_NBR" runat="server" Text='<%#Bind("DOC_NBR")%>'></asp:Label>
                                簽核狀態：<asp:Label ID="lblSTATUS" runat="server" Text='<%#Bind("STATUS")%>'></asp:Label>
                                <asp:Label ID="lblError" runat="server" ForeColor="Red"></asp:Label>
                            </div>
                            <div class="row">
                                <div class="col-md-12 GridViewNormal">
                                    <asp:GridView runat="server" ID="gvOVHBatch"
                                        CssClass="tsGridView2 horzFull"
                                        AutoGenerateColumns="false"
                                        ShowHeader="true"
                                        ShowHeaderWhenEmpty="false"
                                        OnRowDataBound="gvOVHBatch_RowDataBound">
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="中繼表更新狀態">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblZTABLE_STATUS" runat="server" Text='<%#Bind("ZTABLE_STATUS")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="飛騰更新狀態">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblWS_STATUS" runat="server" Text='<%#Bind("WS_STATUS")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="個別加班單單號">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblSUB_DOC_NBR" runat="server" Text='<%#Bind("SUB_DOC_NBR")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:BoundField HeaderText="申請人" DataField="APPLICANT_NAME" />
                                            <asp:BoundField HeaderText="加班折換方式" DataField="CHANGETYPE" />
                                            <asp:BoundField HeaderText="加班時間(起)" DataField="OT_START" />
                                            <asp:BoundField HeaderText="加班時間(迄)" DataField="OT_END" />
