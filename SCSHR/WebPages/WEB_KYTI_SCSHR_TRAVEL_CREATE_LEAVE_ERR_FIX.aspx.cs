...
public partial class CDS_SCSHR_WebPages_WEB_KYTI_SCSHR_TRAVEL_CREATE_LEAVE_ERR_FIX : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            AddSiteMapNode("出差單申請請假單異常處理", Request.Url.AbsoluteUri);
        }
    }
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        if (!string.IsNullOrEmpty(txtDOC_NBR.Text.Trim()))
        {
            ...
            sqlCommand += @" ORDER BY DOC_NBR DESC";
            ...
            foreach (GridViewRow gr in gvTravel.Rows)
            {
                ...
                if (!string.IsNullOrEmpty(lblDOC_NBR.Text))
                {
                    ...
                    if (string.IsNullOrEmpty(lblMSG.Text.Trim()))
                    {
                        ...
                        string WS_STATUS = ReBuildSCSHRForm.ReCallWSUpdateStatus(lblDOC_NBR.Text, Field_ID, "TRAVEL_CREATE_LEAVE");
